...
The `security-policy` workflow's `policy-guard` job runs only trusted base-branch code under
...
ID `owner_policy_guard`. Its run command invokes the base-owned Python file directly. GitHub
